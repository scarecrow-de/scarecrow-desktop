...
#include "scarecrow-rr-config.h"

#include "scarecrow-rr-private.h"
 ...
 *
 * Returns: (array zero-terminated=1) (element-type ScarecrowDesktop.RROutputInfo) (transfer none): the output configuration for this #GnomeRRConfig
 */
GnomeRROutputInfo **
