...
/**
 * SECTION:scarecrow-desktop-thumbnail
 ...
 *
 * #ScarecrowDesktopThumbnailFactory allows generation and loading of thumbnails for
 ...
 * status. #ScarecrowDesktopThumbnailFactory will then fall back to using gdk-pixbuf
 ...
 * #ScarecrowDesktopThumbnailFactory, which handles looking up the right thumbnailer
 * script, building and executing the command for it, and loading the resulting
 * thumbnail image into a #GdkPixbuf.
 *
 * Thumbnail caching is also supported by #ScarecrowDesktopThumbnailFactory. When
 ...
 * so the thumbnail can be looked up in future. #ScarecrowDesktopThumbnailFactory
 ...
 * pixels.
 *
 * #ScarecrowDesktopThumbnailFactory also handles failed thumbnails. If a
 ...
 * for thumbnails for that file, #ScarecrowDesktopThumbnailFactory can immediately
 * return an error after looking up the fail entry.
 *
 * If a file changes content, #ScarecrowDesktopThumbnailFactory will generate a new
...
#include "scarecrow-desktop-thumbnail.h"
...
struct _ScarecrowDesktopThumbnailFactoryPrivate {
...
G_DEFINE_TYPE_WITH_CODE (ScarecrowDesktopThumbnailFactory,
	       gnome_desktop_thumbnail_factory,
	       G_TYPE_OBJECT,
	       G_ADD_PRIVATE (ScarecrowDesktopThumbnailFactory))
...
static void
gnome_desktop_thumbnail_factory_register_mime_types (ScarecrowDesktopThumbnailFactory *factory,
                                                     Thumbnailer                  *thumb)
{
  ScarecrowDesktopThumbnailFactoryPrivate *priv = factory->priv;
  gint i;
...
static void
gnome_desktop_thumbnail_factory_add_thumbnailer (ScarecrowDesktopThumbnailFactory *factory,
                                                 Thumbnailer                  *thumb)
{
  ScarecrowDesktopThumbnailFactoryPrivate *priv = factory->priv;
...
static gboolean
gnome_desktop_thumbnail_factory_is_disabled (ScarecrowDesktopThumbnailFactory *factory,
...
static void
update_or_create_thumbnailer (ScarecrowDesktopThumbnailFactory *factory,
                              const gchar                  *path)
{
  ScarecrowDesktopThumbnailFactoryPrivate *priv = factory->priv;
  GList *l;
...
static void
remove_thumbnailer (ScarecrowDesktopThumbnailFactory *factory,
                    const gchar                  *path)
{
  ScarecrowDesktopThumbnailFactoryPrivate *priv = factory->priv;
  GList *l;
...
static void
remove_thumbnailers_for_dir (ScarecrowDesktopThumbnailFactory *factory,
...
static void
gnome_desktop_thumbnail_factory_load_thumbnailers_for_dir (ScarecrowDesktopThumbnailFactory *factory,
                                                           const gchar                  *path)
{
  ScarecrowDesktopThumbnailFactoryPrivate *priv = factory->priv;
  GDir *dir;
...
static void
gnome_desktop_thumbnail_factory_load_thumbnailers (ScarecrowDesktopThumbnailFactory *factory)
{
  ScarecrowDesktopThumbnailFactoryPrivate *priv = factory->priv;
...
static void
gnome_desktop_thumbnail_factory_init (ScarecrowDesktopThumbnailFactory *factory)
{
  ...
  priv->settings = g_settings_new ("io.github.scarecrow_de.desktop.thumbnailers");
  priv->disabled = g_settings_get_boolean (priv->settings, "disable-all");
  if (!priv->disabled)
    priv->disabled_types = g_settings_get_strv (priv->settings, "disable");
...
static void
gnome_desktop_thumbnail_factory_class_init (ScarecrowDesktopThumbnailFactoryClass *class)
{
 ...
 *
 * Creates a new #ScarecrowDesktopThumbnailFactory.
 *
 * This function must be called on the main thread and is non-blocking.
 *
 * Return value: a new #ScarecrowDesktopThumbnailFactory
 *
 * Since: 2.2
 **/
ScarecrowDesktopThumbnailFactory *
gnome_desktop_thumbnail_factory_new (ScarecrowDesktopThumbnailSize size)
{
  ScarecrowDesktopThumbnailFactory *factory;
 ...
 * @factory: a #ScarecrowDesktopThumbnailFactory
 ...
 **/
char *
gnome_desktop_thumbnail_factory_lookup (ScarecrowDesktopThumbnailFactory *factory,
					const char            *uri,
					time_t                 mtime)
{
  ScarecrowDesktopThumbnailFactoryPrivate *priv = factory->priv;
 ...
 **/
gboolean
gnome_desktop_thumbnail_factory_has_valid_failed_thumbnail (ScarecrowDesktopThumbnailFactory *factory,
							    const char            *uri,
							    time_t                 mtime)
{
  char *path;
 ...
 * @mtime: the mtime of the file
 *
 * Returns TRUE if this ScarecrowDesktopThumbnailFactory can (at least try) to thumbnail
 ...
 **/
gboolean
gnome_desktop_thumbnail_factory_can_thumbnail (ScarecrowDesktopThumbnailFactory *factory,
					       const char            *uri,
 ...
 **/
GdkPixbuf *
gnome_desktop_thumbnail_factory_generate_thumbnail (ScarecrowDesktopThumbnailFactory *factory,
						    const char            *uri,
						    const char            *mime_type)
{
  GdkPixbuf *pixbuf;
 ...
 **/
void
gnome_desktop_thumbnail_factory_save_thumbnail (ScarecrowDesktopThumbnailFactory *factory,
						GdkPixbuf             *thumbnail,
						const char            *uri,
 ...
 **/
void
gnome_desktop_thumbnail_factory_create_failed_thumbnail (ScarecrowDesktopThumbnailFactory *factory,
							 const char            *uri,
							 time_t                 mtime)
{
  char *path;
